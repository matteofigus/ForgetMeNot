...
{
	[TestFixture]
	public abstract class Scheduler_Spec : IConsume<ReminderMessages.ScheduledReminderHasBeenJournaled>
	{
		...
		public void GivenA(ReminderMessages.ScheduledReminderHasBeenJournaled journaledReminder)
		{
